...
class Window {
 public:
   ...
   * 
   * This function should be called to start the main loop of the window.
 ...
 private:
   ...
   * 
   * This function is called by the Run() function to handle input events.
   * It updates the state of the keyboard and mouse objects.
   */
  void HandleInput();
   ...
   * 
   * This function is called by the constructor to initialize the GLFW window.
   */
  void InitWindow();
   ...
   * 
   * This function is called by the destructor to clean up resources used by the GLFW window.
   */
  void Cleanup();
  ...
  bool show_cursor_ = false;         /**< Flag indicating if the cursor is visible.     */
};
